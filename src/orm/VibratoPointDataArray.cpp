...
namespace dspx {
    ...
    namespace {
        ...
        VibratoPointDataArray *vibratoPointOwnerFromAssociationValue(ModelPrivate &model,
            ...
            auto *note = createIfMissing ? model.ensure<Note>(noteHandle)
                                         : model.find<Note>(noteHandle);
            if (!note) {
                return nullptr;
            }
    ...
    namespace orm {
        ...
        void collectVibratoPointDataArrayChanges(ModelPrivate &model,
            ...
            for (const auto &group : groups) {
                ...
                auto *owner = vibratoPointOwnerFromAssociationValue(model, group.associationValue, false);
                if (!owner) {
                    continue;
                }
